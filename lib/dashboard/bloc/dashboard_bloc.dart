...
class DashboardBloc extends Bloc<DashboardEvent, DashboardState> {
  ...
  FutureOr<void> dashboardInitialFechEvent(
    ...
    try {
      String rpcUrl = "http://192.168.140.60:7545";
      String socketUrl = "ws://192.168.140.60:7545";
      ...
      _contractAddress =
          EthereumAddress.fromHex("0xeB706F5cC230a8F27E6Cb6152ee652c8b8Fd01Aa");
      ...
      final balanceData = await _web3Client!
        ...
        EthereumAddress.fromHex("0x82f99FF41a311490a7445D68Cf2888967265E675")
      ]);
    ...
    try {
      final transaction = Transaction.callContract(
          from: EthereumAddress.fromHex(
              "0x82f99FF41a311490a7445D68Cf2888967265E675"),
          contract: _deployedContract,
          function: _deposit,
          parameters: [
